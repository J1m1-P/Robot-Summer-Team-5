...
inline StepperConfig towerXConfig {PIN_STEP1, PIN_STEP1_DIR, true, 3, 700, 150, X};
inline StepperConfig towerZConfig {PIN_STEP2, PIN_STEP2_DIR, true, 3, 500, 220, Z};
...
inline StepperConfig habitatZConfig {PIN_STEP3, PIN_STEP3_DIR, true, 3, 500, 152, Z};
