...
inline StepperConfig towerXConfig {PIN_STEP1, PIN_STEP1_DIR, true, 3, 600, 150, X};
inline StepperConfig towerZConfig {PIN_STEP2, PIN_STEP2_DIR, true, 3, 600, 220, Z};
...
inline StepperConfig habitatXConfig {PIN_STEP4, PIN_STEP4_DIR, true, 3, 700, 187, X};
inline StepperConfig habitatZConfig {PIN_STEP3, PIN_STEP3_DIR, true, 3, 600, 152, Z};
