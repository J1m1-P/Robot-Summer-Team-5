...
inline StepperConfig towerZConfig {PIN_STEP2, PIN_STEP2_DIR, false, 3, 1000, 220, Z};
...
inline StepperConfig habitatZConfig {PIN_STEP3, PIN_STEP3_DIR, true, 3, 2000, 152, Z};
