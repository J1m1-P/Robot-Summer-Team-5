...
static const ServoConfig towerRightServoConfig {PIN_SERVO_TOWER_RIGHT_PWM, 0, 50, "open", "close", SERVO_MIN_PULSE_WIDTH_US, SERVO_MAX_PULSE_WIDTH_US, SERVO_FREQUENCY_HZ};
