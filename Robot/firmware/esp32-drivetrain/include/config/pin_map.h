...
#define PIN_TF_BACK_INPUT       3   // Pin for Tape Following output 2
#define PIN_TF_LEFT_INPUT       2   // Pin for Tape Following output 3
...
#define PIN_SOLAR_PANEL_MICROSWITCH 9  // Active LOW: closed to ground; open is disconnected
