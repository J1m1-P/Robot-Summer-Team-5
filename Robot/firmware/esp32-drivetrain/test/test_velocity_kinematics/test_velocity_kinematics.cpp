...
// (control/drivetrain_velocity_kinematics.h), independent of the old duty
// mixer. Complements test_kinematics_parity, which only checks *sign*
// agreement against the old model -- this checks the formula's actual
